 ...
 * @author Marcin Malec
 * 
 * Note: If my evaluator was adapted without errors the performance is: 
 * 49.759521340383344 with epsilon = 1e-12;
 * (Todd: That is, the ANNPlayer should win against an optimal player 49.76% of the time.) 
 */
public class ANNPlayer extends RedLightPlayer {
	private static int numReds = 4, numGreens = 24, numChips = numReds + numGreens, goalScore = 50;
	private static NeuralNetwork ann = new NeuralNetwork(new double[][][]{{{-0.7970040404210204, -3.2514315100752764, 22.245286759356613, 10.857268833426224, -0.8573955299957158, 12.290300336850772, -41.14597562481358, 48.799449630259446},
